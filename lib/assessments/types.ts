...
export const PATHWAYS: PathwayMeta[] = [
  ...
  },
  {
    ...
    subtitle: "How you connect — and disconnect — under pressure",
    description: "Explore your patterns in partnership, vulnerability, trust, and how secure the bonds in your life actually feel from the inside.",
    estimatedMinutes: 6,
    questionCount: 10,
    icon: "Heart",
  ...
  {
    id: "self-worth-inner-critic",
    slug: "self-worth-inner-critic",
    title: "Self-Worth & Inner Critic",
    subtitle: "The voice in your head that says you're not enough",
    description: "Map your relationship with perfectionism, shame, self-compassion, and the running commentary that shapes how you feel about everything you do.",
    estimatedMinutes: 6,
    questionCount: 11,
    icon: "Shield",
  ...
  {
    id: "rage-emotional-dysregulation",
    slug: "rage-emotional-dysregulation",
    title: "Rage & Emotional Dysregulation",
    subtitle: "The explosion you can't always stop",
    description: "Name the rage pattern without shame. Understand its triggers, its aftermath, and what it's actually trying to tell you about your life.",
    estimatedMinutes: 5,
    questionCount: 9,
    icon: "Zap",
  ...
  {
    id: "matrescence-identity",
    slug: "matrescence-identity",
    title: "Matrescence & Identity",
    subtitle: "The earthquake of becoming a mother",
    description: "Explore the grief of your old self, the taboo feelings nobody talks about, and the slow work of rebuilding identity within — not despite — motherhood.",
    estimatedMinutes: 5,
    questionCount: 9,
    icon: "Fingerprint",
    color: "bg-indigo-500/10 text-indigo-600",
  ...
  },
  {
    ...
    slug: "social-connection-isolation",
    title: "Social Connection & Isolation",
    subtitle: "Needed by everyone, known by no one",
    description: "Map your loneliness, your friendships, and the energy it costs to appear okay in a world that doesn't ask how you really are.",
    estimatedMinutes: 5,
    questionCount: 9,
    icon: "Users",
