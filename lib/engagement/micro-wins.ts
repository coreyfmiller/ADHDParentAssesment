...
const categoryKeywords: Record<string, string[]> = {
  exercise: ["exercise", "exercised", "ran", "run", "running", "jog", "yoga", "stretch", "stretched", "workout", "worked out", "gym", "lifted", "weights", "swim", "swam", "bike", "biked", "hiking", "hiked", "pilates", "danced"],
  ...
  care: ["water", "rest", "nap", "walked", "outside", "breath", "sat down", "quiet", "alone", "bath", "bathed", "journal", "read", "tea", "coffee", "vitamin", "supplement", "skincare", "lotion", "makeup", "hair", "meditat"],
...
const reflections: Record<string, string[]> = {
  ...
  exercise: [
    "You moved your body. Your brain thanks you — dopamine, serotonin, BDNF. All released.",
    "Exercise when you're depleted is twice as hard. You did it anyway.",
    "Your nervous system just got a reset. That's better than any pill.",
    "You chose to move when staying still would have been easier. That's discipline disguised as self-care.",
    "Every time you move, you're building a brain that works better for you. Compound interest.",
    "You didn't wait for motivation. You moved first. Motivation will follow.",
    "Your body carried you through that. The same body you criticize. It showed up for you.",
    "Movement is regulation. You just regulated yourself in the healthiest way possible.",
    "That post-exercise clarity? That's your prefrontal cortex coming back online. Use it.",
    "You invested in tomorrow's capacity. Tomorrow-you will have more because of today-you.",
    "Not a punishment. Not earning food. Just a human body doing what it was built to do.",
    "You chose something hard over something easy. That pattern builds everything.",
    "The hardest part was starting. And you started. The rest was momentum.",
    "Movement is the fastest way to change your emotional state. You just proved it.",
    "You gave your body what screens and snacks can't: actual neurochemical relief.",
    "One workout won't change your life. But a person who works out will. You're that person today.",
    "You moved. In a life that makes movement hard. That's not small.",
    "Your kids just watched you choose your health. That's modeling. That's parenting.",
    "The executive function boost from exercise lasts hours. You just bought yourself capacity.",
    "Moving when depleted is an act of faith that it'll help. And it does. Every time.",
    "Your body isn't the enemy. It just proved it's on your side.",
    "You did something that required zero perfection and gave maximum return. Smart.",
    "That was you fighting for yourself. With your body. In the most literal sense.",
    "Exercise isn't about how you look. It's about how your brain works. And yours works better now.",
    "You chose discomfort now for relief later. That's future-self kindness.",
    "The anxiety in your chest just got smaller. Your body did that. Because you moved it.",
    "Not everyone who's exhausted can make themselves exercise. You did. That's remarkable.",
    "You burned off the cortisol that was eating you alive. Good.",
    "Your brain just got a bath of neurochemicals it's been starving for. You did that.",
    "Movement is the reset button your nervous system needed. Pressed.",
  ],
  uncategorized: [
    "Logged. Counted. Real.",
